...
<template>
    <main>
        <HeroPages title="Leilões financeiros ágeis e transparentes" subtitle="Leilões financeiros em alta velocidade, com segurança e formação de preços por oferta e demanda e pós definidos" img="https://placehold.co/600x440?text=IMG" buttom/>
        <section class="container flex flex-col gap-8 mx-auto pb-24 place-items-center pt-16 px-4 md:flex-row md:justify-between">
            <nuxt-img src="https://placehold.co/600x400?text=IMG" fit="cover" class="md:w-1/2"/>
            <div class="title">
                <h3>O que fazemos</h3>
        ...
        <section class="bg-slate-100">
            <div class="container flex flex-col gap-8 mx-auto pb-24 place-items-center pt-16 px-4 md:flex-row md:justify-between">
                <div class="title">
                    <h3>O que fazemos</h3>
            ...
            são as responsáveis pela boletagem e pela liquidação das operações. </p>
                    <UButton to="" label="Comece agora" size="xl" class="!rounded-3xl blue mt-4 px-7 py-3"/>
                </div>
                <nuxt-img src="https://placehold.co/600x400?text=IMG" fit="cover" class="md:w-1/2"/>
            </div>
        </section>
        <section class="container mx-auto pb-24 pt-16 px-4">
            <div class="mx-auto">
                <div class="title">
                    <h3>Não definido</h3>
                    <h2>Não definido</h2>
            ...
            <div class="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-[repeat(auto-fit,_minmax(200px,_1fr))]">
              ...
              market </p>
                ...
                <div class="border-r-2">
                    <div class="border-b-2 h-16 flex place-items-center place-content-center">
                        <p>Calls</p>
                    </div>
                ...
                <div class="border-r-2">
                    <div class="border-b-2 h-16 flex place-items-center place-content-center">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" class="h-full w-full">
        ...
        <section class="bg-slate-100">
            ...
            casada. </p>
                ...
                <div class="flex gap-4 justify-around w-full">
                    <div class="gap-4 flex flex-col place-content-center place-items-center">
                        <nuxt-img src="/preco.svg" width="80"/>
                        <h6 class="text-center">Preço<br/>e lote</h6>
                    </div>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 37 41" class="rotate-90 w-8 md:rotate-0">
                        <path fill="#C9CDD9" d="M33.5 15a6.3 6.3 0 0 1 0 11L10 39.6A6.3 6.3 0 0 1 .5 34V7c0-5 5.2-8 9.4-5.6L33.5 15Z"/>
                    </svg>
                    <div class="gap-4 flex flex-col place-content-center place-items-center">
        ...
        <section class="container mx-auto pb-24 pt-16 px-4">
            <div class="mx-auto">
                <h2 class="lg:text-center">FAQ</h2>
            </div>
            <UAccordion :items="items" variant="link" size="xl" class="border-b border-gray-100 dark:border-gray-700 mx-auto py-6 rounded-none text-blue-900 w-10/12">
                <template #faq1>
