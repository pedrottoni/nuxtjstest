<script setup lang="ts">
  ...
  onMounted(() => {
    ...
    for (let i = 0; i < titles.length; i++) {
      $gsap.matchMedia().add('(min-width: 24px)', () => {
        $gsap.from(titles[i], {
          ease: 'power1.out',
          opacity: -1 - i * 1.5,
          yPercent: 100 + i / 60,
