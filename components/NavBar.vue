            ...
            <div class="flex h-fit items-center justify-between py-3">
                <div class="flex items-center justify-between w-full">
                    <div class="flex flex-shrink-0 items-center">
                        <NuxtLink to="/" class="text-primary-600" title="EXE Auctions">
                    ...
                    <NavBarDesktopTabs :navlinks="desktopNavTabs" :current-path="currentPath" class="hidden gap-4 lg:flex sm:ml-6"/>
                </div>
                <UModal v-model="isOpen">
                    <div class="bg-slate-800 flex flex-col place-items-center px-6 py-8">
                        <div class="border-2 border-slate-50 flex h-24 p-4 rounded-full w-24">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 83 27" class="w-20">
                                <path fill="#FBFCFD" d="M25.76 3.43H4.92v8.68h16.1V15H4.91v8.57h20.84v2.88H0V.55h25.76v2.88Z"/>
                                <path fill="#FBFCFD" d="M56.81.55v2.88h20.84v8.68h-16.1V15h16.1v8.57H56.81v2.88h25.76V.55H56.81Z"/>
                                <path fill="#FBFCFD" d="M47.65 10.17 56.8.55l-6.48.09-5.8 6.25 3.12 3.28Z"/>
              ...
              Para acessar, escolha uma das opções abaixo: </p>
                        <UButton label="Sandbox" block class="button-sandbox mb-2 py-3 rounded-md"/>
                        <UButton label="Devs" block class="button-dev py-3 rounded-md" color="tertiary"/>
                        <UButton color="gray" variant="ghost" icon="i-heroicons-x-mark-20-solid" class="-my-1 absolute right-3 text-tertiary-500 top-4" @click="isOpen = false"/>
                    </div>
                </UModal>
                <UButton class="btn font-bold mr-3 px-6 py-2 ring-2 ring-tertiary-500 rounded-md md:ml-12" label="Entrar" color="tertiary" variant="outline" @click="isOpen = true"/>
