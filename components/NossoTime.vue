...
<template>
  <section id="time" class="container flex flex-col mx-auto pb-40 pt-32 px-4">
    ...
    <div
      class="cards gap-11 grid lg:gap-4 lg:grid-cols-[repeat(auto-fit,_minmax(200px,_1fr))] place-items-center sm:grid-cols-2 w-full xl:gap-8"
    >
      <UCard
      ...
      >
        ...
        <template #footer>
          <div class="px-5">
            <UButton
              to="https://www.linkedin.com/in/guilherme-corsini/"
              label="Linkedin"
              variant="link"
      ...
      >
        ...
        <template #default>
          <div class="border-gray-50 flex flex-col mt-6 pt-0 px-5">
            <div>
              ...
              <p>
                Ha mais de 30 anos no mercado financeiro, desenvolveu mercados
        ...
        <template #footer>
          <div class="px-5">
            <UButton
              to="https://www.linkedin.com/in/adolpho-souza-naves-neto-7590b764"
              label="Linkedin"
              variant="link"
              class="text-primary-500"
              trailing-icon="i-material-symbols-open-in-new"
      ...
      >
          ...
          <div class="border-gray-50 flex flex-col mt-6 pt-0 px-5">
            <div>
              ...
              <p>
                ...
                tecnologias digitais e seu poder disruptivo em negócios
        ...
        <template #footer>
          <div class="px-5">
            <UButton
              to="https://www.linkedin.com/in/jack-cavalcanti-63983113/"
              label="Linkedin"
              variant="link"
              class="text-primary-500"
              trailing-icon="i-material-symbols-open-in-new"
      ...
      >
        ...
        <template #footer>
          <div class="px-5">
            <UButton
              to="https://www.linkedin.com/in/mervyn-lowe-2822962/"
              label="Linkedin"
              variant="link"
              class="text-primary-500"
              trailing-icon="i-material-symbols-open-in-new"
