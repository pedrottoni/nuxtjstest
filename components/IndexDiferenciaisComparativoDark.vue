...
<template>
  <section id="diferencial" class="overflow-hidden py-36 relative">
    <div class="relative z-10 container flex flex-col mx-auto px-4">
      ...
      <div
        class="border-b-2 border-opacity-50 border-primary-300 comparativo gap-0 grid grid-cols-3 grid-rows-7 h-96 overflow-scroll place-self-center relative rounded-lg text-slate-50 w-full md:border-2 md:border-opacity-10 md:border-primary-300 md:grid-cols-9 md:h-full md:overflow-hidden md:p-8 md:rounded-2xl"
      >
        <div
          class="border-b-0 border-l-2 border-opacity-30 border-primary-300 border-r-2 border-t-2 col-span-3 hidden md:flex h-full md:border-0 md:pl-8 md:place-content-start md:py-0 md:rounded-tl-lg place-content-center place-items-center md:py-4 text-slate-50 w-full"
        >
        ...
        <div
          class="border-2 border-opacity-30 border-primary-300 calls flex h-full place-content-center place-items-center place-self-start py-8 rounded-tl-lg self-start sticky text-slate-50 w-full z-10 md:border-b-0 md:border-l-r-0 md:border-r-0 md:border-t-0 md:col-span-2 md:rounded-t-none"
        >
          <h6 class="font-semibold text-center text-white md:text-lg">Calls</h6>
        </div>
        <div
          class="ats border-b-2 border-l-r-2 border-opacity-30 border-primary-300 border-r-2 border-t-2 flex h-full place-content-center place-items-center place-self-end py-8 text-slate-50 w-full z-10 md:border-b-0 md:border-l-t-0 md:border-r-0 md:border-t-0 md:col-span-2 md:rounded-t-none"
        >
          <h6 class="font-semibold text-center text-white md:text-lg">
            ATS/Dark pools
          </h6>
        ...
        <div
          class="bgexe border-b-2 border-l-0 border-opacity-30 border-primary-300 border-r-2 border-t-2 border-t-r-2 flex h-full place-content-center place-items-center place-self-end rounded-tr-md w-full z-10 md:border-0 md:col-span-2 md:py-8 md:rounded-t-xl"
        >
          <svg
        ...
        <div
          class="border-b-0 border-l-2 border-opacity-30 border-primary-300 border-r-2 border-t-0 col-span-3 flex h-full place-content-center place-items-center py-4 text-slate-50 w-full md:border-b-0 md:border-l-0 md:border-r-0 md:border-t-2 md:place-content-start md:px-8 md:py-0"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
        ...
        <div
          class="border-2 border-opacity-30 border-primary-300 flex flex-col h-full md:border-b-0 md:border-r-0 md:border-t-2 md:col-span-2 place-content-end place-items-center px-3 py-4 md:py-8 text-slate-50 w-full"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
        ...
        <div
          class="border-b-2 border-l-b-2 border-opacity-30 border-primary-300 border-r-0 border-t-2 flex flex-col h-full place-content-end place-items-center px-3 py-4 md:py-8 text-slate-50 w-full md:border-b-0 md:border-r-0 md:border-t-2 md:col-span-2"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 47 54"
        ...
        <div
          class="bg-opacity-20 bg-primary-400 border-2 border-opacity-30 border-primary-300 flex flex-col h-full place-content-end place-items-center px-3 py-4 w-full z-10 md:border-b-0 md:border-l-0 md:border-r-0 md:border-t-b-0 md:col-span-2 md:py-8"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
        ...
        <div
          class="border-b-2 border-l-2 border-opacity-30 border-primary-300 border-r-2 col-span-3 flex h-full place-content-center place-items-center py-4 text-slate-50 w-full md:border-b-0 md:border-l-0 md:border-r-0 md:border-t-2 md:place-content-start md:px-8 md:py-0"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
        ...
        <div
          class="border-b-2 border-l-2 border-opacity-30 border-primary-300 border-r-2 flex flex-col h-full md:border-b-0 md:border-r-0 md:border-t-2 md:col-span-2 md:py-8 place-content-end place-items-center px-3 py-4 text-slate-50 w-full"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 47 54"
        ...
        <div
          class="border-b-2 border-l-b-2 border-opacity-30 border-primary-300 border-r-0 border-t-b-2 flex flex-col h-full md:border-b-0 md:border-r-0 md:border-t-2 md:col-span-2 md:py-8 place-content-end place-items-center px-3 py-4 text-slate-50 w-full"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
        ...
        <div
          class="bg-opacity-20 bg-primary-400 border-b-2 border-l-2 border-opacity-30 border-primary-300 border-r-2 border-t-0 flex flex-col h-full md-row-span-2 md:border-b-0 md:border-l-0 md:border-r-0 md:border-t-2 md:col-span-2 md:py-8 place-content-end place-items-center px-3 py-4 w-full z-10"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
        ...
        <div
          class="border-b-2 border-l-2 border-opacity-30 border-primary-300 border-r-2 col-span-3 flex h-full place-content-center place-items-center py-4 text-slate-50 w-full md:border-b-0 md:border-l-0 md:border-r-0 md:border-t-2 md:pl-8 md:place-content-start md:pr-14 md:py-0 md:rounded-bl-lg"
        >
          <svg
            width="55"
            height="49"
        ...
        <div
          class="border-l-2 border-opacity-30 border-primary-300 border-r-2 border-t-b-2 flex flex-col h-full place-content-end place-items-center px-3 py-4 rounded-bl-lg text-slate-50 w-full md:border-b-0 md:border-r-0 md:border-t-2 md:col-span-2 md:py-8 md:rounded-bl-none"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 47 54"
        ...
        <div
          class="border-l-b-2 border-opacity-30 border-primary-300 border-r-0 border-t-b-2 flex flex-col h-full place-content-end place-items-center px-3 py-4 text-slate-50 w-full md:border-b-0 md:border-r-0 md:border-t-2 md:col-span-2 md:py-8"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 47 54"
        ...
        <div
          class="bg-opacity-20 bg-primary-400 border-l-2 border-opacity-30 border-primary-300 border-r-2 border-t-0 flex flex-col h-full place-content-end place-items-center px-3 py-4 rounded-br-lg w-full z-10 md:border-b-0 md:border-l-0 md:border-r-0 md:border-t-2 md:col-span-2 md:py-8 md:rounded-b-xl"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
