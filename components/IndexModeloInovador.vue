...
<template>
  <div class="container mx-auto pb-32 pt-24 px-4 md:pb-40">
    ...
    <div
      class="gap-6 lg:gap-16 xl:gap-12 grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-[repeat(auto-fit,_minmax(200px,_1fr))]"
    >
      <UCard>
        <template #header>
      ...
      <UCard>
        ...
        <template #default>
          <p>
            ...
            existia compra, venda ou nao; o preço final e a quantidade total.
          </p>
        </template>
        <template #footer>
          <UButton
