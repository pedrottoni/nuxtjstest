...
<template class="bg-secondary-50">
  <section class="pt-32 pb-40">
    <div class="container flex flex-col mx-auto px-4">
      ...
      <div
        class="bg-transparent comparativo gap-0 grid grid-cols-3 grid-rows-7 max-w-5xl overflow-hidden place-self-center relative rounded-lg w-full md:grid-cols-9 md:h-full"
      >
        <div
          class="border-slate-200 hidden place-items-end place-self-end py-8 w-full md:col-span-3 md:flex"
        ></div>
        <div
          class="bg-slate-100 border-b-0 border-l-2 border-r-2 border-secondary-10 border-t-2 flex h-full place-content-center place-items-end place-self-end py-8 rounded-t-lg w-full z-10 md:col-span-2"
        >
        ...
        <div
          class="bg-slate-100 border-l-r-2 border-r-2 border-secondary-10 border-t-2 flex h-full place-content-center place-items-end place-self-end py-8 rounded-t-lg w-full z-10 md:col-span-2"
        >
          <h6 class="font-semibold md:text-lg text-center text-slate-500">
            ATS/Dark pools
          </h6>
        ...
        <div
          class="bgexe border-l-r-2 border-r-2 border-slate-300 border-t-r-2 flex h-full place-content-center place-items-end place-self-end py-8 rounded-tl-lg rounded-tr-md w-full z-10 md:col-span-2"
        >
          <svg
        ...
        <div
          class="bg-slate-100 border-b-0 border-l-2 border-r-2 border-slate-200 border-t-2 col-span-3 flex h-full place-content-center place-items-center py-4 w-full md:border-b-2 md:border-l-r-0 md:border-r-0 md:border-t-r-0 md:pl-8 md:place-content-start md:py-0 md:rounded-tl-lg"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
        ...
        <div
          class="bg-slate-50 border-2 border-slate-200 flex flex-col h-full place-content-end place-items-center px-3 py-10 w-full md:col-span-2"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
        ...
        <div
          class="bg-slate-50 border-b-2 border-l-b-2 border-r-2 border-slate-200 border-t-2 flex flex-col h-full md:col-span-2 place-content-end place-items-center px-3 py-10 w-full"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 47 54"
        ...
        <div
          class="bg-real-white-100 border-b-2 border-r-2 border-slate-200 border-t-2 flex flex-col h-full md:col-span-2 place-content-end place-items-center px-3 py-10 w-full z-10"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
        ...
        <div
          class="bg-slate-100 border-b-2 border-l-2 border-r-2 border-slate-200 col-span-3 flex h-full place-content-center place-items-center py-4 w-full md:border-b-2 md:border-r-0 md:border-t-0 md:pl-8 md:place-content-start md:py-0"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
        ...
        <div
          class="bg-slate-50 border-b-2 border-l-2 border-r-2 border-slate-200 flex flex-col h-full place-content-end place-items-center px-3 py-10 w-full md:col-span-2"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 47 54"
        ...
        <div
          class="bg-slate-50 border-b-2 border-r-2 border-slate-200 flex flex-col h-full md:col-span-2 place-content-end place-items-center px-3 py-10 w-full"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
        ...
        <div
          class="bg-real-white-100 border-b-2 border-r-2 border-slate-200 flex flex-col h-full md-row-span-2 place-content-end place-items-center px-3 py-10 w-full z-10 md:col-span-2"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
        ...
        <div
          class="bg-slate-100 border-b-2 border-l-2 border-r-2 border-slate-200 col-span-3 flex h-full place-content-center place-items-center py-4 w-full md:border-b-r-0 md:border-r-0 md:border-t-0 md:pl-8 md:place-content-start md:py-0 md:rounded-bl-lg"
        >
          <svg
            width="55"
            height="49"
        ...
        <div
          class="bg-slate-50 border-b-2 border-l-2 border-r-2 border-slate-200 border-t-b-2 flex flex-col h-full place-content-end place-items-center px-3 py-10 rounded-bl-lg w-full md:col-span-2 md:pb-12 md:rounded-bl-none"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 47 54"
        ...
        <div
          class="bg-slate-50 border-b-2 border-r-2 border-slate-200 flex flex-col h-full md:col-span-2 md:pb-12 place-content-end place-items-center px-3 py-10 w-full"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 47 54"
        ...
        <div
          class="bg-real-white-100 border-b-2 border-l-b-2 border-r-2 border-slate-200 border-t-b-2 flex flex-col h-full place-content-end place-items-center px-3 py-10 rounded-br-lg w-full z-10 md:border-b-2 md:col-span-2 md:pb-12"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
