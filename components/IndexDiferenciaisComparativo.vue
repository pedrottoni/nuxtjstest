...
<template class="bg-secondary-50">
  <section class="pt-32 pb-40">
    <div class="container flex flex-col mx-auto place-items-center px-4">
      <div
        class="flex-col mb-24 text-center lg:flex lg:max-w-2xl lg:place-items-center"
      >
        <h3>Diferencial</h3>
      ...
      <div
        class="bg-transparent comparativo gap-0 grid grid-cols-3 grid-rows-7 max-w-5xl overflow-hidden place-items-center relative rounded-2xl w-full md:grid-cols-9 md:h-full"
      >
        <div
          class="border-slate-200 hidden place-items-end place-self-end py-8 w-full md:col-span-3 md:flex"
        ></div>
        <div
          class="bg-slate-100 border-b-0 border-l-2 border-r-2 border-secondary-10 border-t-2 flex h-full place-content-center place-items-end place-self-end py-8 rounded-t-2xl w-full z-10 md:col-span-2"
        >
        ...
        <div
          class="bg-slate-100 border-l-r-2 border-r-2 border-secondary-10 border-t-2 flex h-full place-content-center place-items-end place-self-end py-8 rounded-t-2xl w-full z-10 md:col-span-2"
        >
          <h6 class="font-semibold md:text-lg text-center text-slate-500">
            ATS/Dark pools
          </h6>
        ...
        <div
          class="bgexe border-l-r-2 border-r-2 border-slate-300 border-t-r-2 flex h-full place-content-center place-items-end place-self-end py-8 rounded-t-2xl w-full z-10 md:col-span-2"
        >
          <svg
        ...
        <div
          class="bg-slate-100 border-2 border-slate-200 col-span-3 flex h-full place-content-center place-items-center w-full md:border-r-0 md:pl-8 md:place-content-start md:rounded-tl-2xl py-4 md:py-0"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
        ...
        <div
          class="bg-slate-100 border-2 border-slate-200 col-span-3 flex h-full place-content-center place-items-center w-full md:border-b-2 md:border-r-0 md:border-t-0 md:pl-8 md:place-content-start py-4 md:py-0"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
        ...
        <div
          class="bg-slate-100 border-2 border-slate-200 col-span-3 flex h-full place-content-center place-items-center w-full md:border-b-r-0 md:border-r-0 md:border-t-0 md:pl-8 md:place-content-start py-4 md:py-0 md:rounded-bl-2xl"
        >
          <svg
            width="55"
            height="49"
        ...
        <div
          class="bg-slate-50 border-b-2 border-l-2 border-r-2 border-slate-200 border-t-b-2 flex flex-col h-full place-content-end place-items-center px-3 py-10 rounded-bl-2xl w-full md:col-span-2 md:pb-12 md:rounded-bl-none"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 47 54"
        ...
        <div
          class="bg-real-white-100 border-b-2 border-r-2 border-slate-200 flex flex-col h-full place-content-end place-items-center px-3 py-10 rounded-br-2xl w-full z-10 md:col-span-2 md:pb-12"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
